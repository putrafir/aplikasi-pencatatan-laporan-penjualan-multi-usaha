            ...
            <tbody>
                @foreach ($keranjangs as $keranjang)
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2">{{ $keranjang->menu->nama }}</td>
                        <td class="border border-gray-300 px-4 py-2">@php echo number_format($keranjang->menu->harga, 0, ',', '.'); @endphp</td>
                        <td class="border border-gray-300 px-4 py-2">{{ $keranjang->jumlah }}</td>
                        <td class="border border-gray-300 px-4 py-2">@php echo number_format($keranjang->total_harga, 0, ',', '.'); @endphp</td>
