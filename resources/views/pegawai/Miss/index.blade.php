...
@section('pegawai')
    <div class="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 ">
        ...
        <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
            <a href="#"
                ...
                <div class="text-left rtl:text-right">
                    ...
                    <div class="-mt-1 font-sans text-sm font-semibold">Miss Smoothies</div>
                </div>
            </a>
            <a href="#"
                class="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 ">
                ...
                <div class="text-left rtl:text-right">
                    ...
                    <div class="-mt-1 font-sans text-sm font-semibold">Miss Hotang</div>
                </div>
            </a>
        </div>
    </div>
