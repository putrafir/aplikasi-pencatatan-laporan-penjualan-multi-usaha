...
@section('admin')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        @foreach ($business as $bisnis)
            <div class="relative overflow-hidden max-w-sm md:max-w-md h-full bg-gray-100 rounded-2xl shadow-md flex items-center p-4">
                ...
                <div class="pl-[13rem] xl:pl-[14rem] md:pl-[16rem] text-white mr-auto z-10">
