    ...
    <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
        ...
        <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
            ...
            <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                ...
                <li class="mt-0.5">
                    <a class="{{ Request::routeIs('admin.profile')
                        ...
                        <span
                            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">{{ Auth::user()->name }}</span>
                        <div
                            class="{{ Request::routeIs('admin.profile')
                                ? 'bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl ml-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5'
                ...
                <li class="flex items-center pl-4 xl:hidden">
                    <a href="javascript:;" id="burger-icon" class="block p-0 transition-all ease-nav-brand text-sm text-slate-500">
                        <div class="w-6 h-5 flex flex-col justify-between">
                            <span class="burger-line block h-0.5 w-6 bg-slate-500 transition-all"></span>
                            <span class="burger-line block h-0.5 w-6 bg-slate-500 transition-all"></span>
                            <span class="burger-line block h-0.5 w-6 bg-slate-500 transition-all"></span>
                        </div>
                    </a>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        const sidenavTrigger = document.getElementById("burger-icon");
