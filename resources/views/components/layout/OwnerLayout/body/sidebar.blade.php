<aside
    ...
    class="max-w-62.5 ease-nav-brand z-50 fixed inset-y-0 my-4 block w-full md:border -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 md:left-0 md:translate-x-0 md:bg-transparent"
